/* --- Copyright University of Sussex 1993. All rights reserved. ----------
 > File:            C.x/x/pop/lib/Xol/xolMenuButtonWidget.p
...
XptLoadWidgetClass xolMenuButtonWidget [^^XOL_EXLIBS]
    xolMenuButtonWidget <- menuButtonWidgetClass
;

XptSpecifyResourceInfo(xolMenuButtonWidget,
