/* --- Copyright University of Sussex 1992. All rights reserved. ----------
 > File:            C.all/lib/ved/term/vedvt200screen.p
 > Purpose:         Configure VED for VT200 type terminal
 > Author:          Robert John Duncan, Oct 22 1990 (see revisions)
 > Documentation:
 > Related Files:   LIB * VEDVT220SCREEN, * VEDVT200KEYS
 */
...
define vedvt200screen();
    false -> vedterminalname;
    if testdef vedtermcapscreen
    and (weakref vedtermcapscreen('vt200'); vedterminalname)
    then
        vedset screen;
            graphic         = esc ( 0
            alpha           = esc ( B
